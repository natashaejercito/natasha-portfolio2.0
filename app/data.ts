export const PROJECTS = [
  ...
  { id: 'sa-004', catalog: 'NE-004', title: 'IS Forecast', genre: 'SYSTEMS', year: '2026', desc: 'Helps innovation space to render data of the current and future progress.', color: '#e7dcc2', dark: false, repo: 'https://github.com/natashaejercito/platter' },
