  ...
  return (
    <div style={{
      ...
      <div className="nowplaying-controls" style={{ display: 'flex', alignItems: 'center', gap: 14, flex: 1.4, maxWidth: 520, minWidth: 0 }}>
        ...
        <a
          href={np.repo} target="_blank" rel="noopener noreferrer"
          title="View repository"
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--muted)', flex: '0 0 auto', textDecoration: 'none', transition: 'color .2s' }}
