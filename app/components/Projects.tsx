  ...
  return (
    <section id="work" style={{
      ...
      <div style={{ maxWidth: 1180, margin: '0 auto', padding: 'clamp(48px,7vw,80px) clamp(20px,5vw,56px) clamp(60px,8vw,96px)' }}>
        ...
        {/* Genre tabs */}
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 6, marginTop: 30, paddingLeft: 2, borderBottom: '1px solid rgba(255,255,255,0.15)', flexWrap: 'wrap' }}>
          {GENRES.map(g => {
        ...
        {/* Project grid */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(228px,1fr))', gap: 'clamp(26px,3vw,42px) clamp(20px,2.4vw,32px)', marginTop: 40 }}>
          {filtered.map((p, i) => {
              ...
              >
                <div style={{ position: 'relative', overflow: 'visible' }}>
                  ...
                  <div style={{
                    ...
                    borderRadius: '50%',
                    transform: `translateX(-50%) translateY(${isHov ? '-33%' : '4%'})`,
